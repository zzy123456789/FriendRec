...
public class FriendRecTop_belta {
...
//		System.out.println("the paraItemLike  is " + Arrays.toString(paraItemLike));
	 ...
	 */
	int[] recommendListForOneUser(int paraUserIndex, double paraRecThreshold, double paraLikeThreshold, int paraK,
			int paraN, double paraBelta) {
		...
		itemLike = orderItemLike(tempCompRecRatio, tempCompRecLists, paraN);
		// System.out.println("the itemLike = " + Arrays.toString(itemLike));
	...
	public static void main(String[] args) {
		try {
			...
			FriendRecTop_belta tempFri = new FriendRecTop_belta();
			//Group 1 Experiments
...
//			tempFri.dataModel = new DataModel(30444,16121);
			...
			double tempRecThreshold = 0;
			double belta = 0.1;//Indirect friend weights
